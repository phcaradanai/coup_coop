...
export const ROLE_VIDEOS: Partial<Record<CyberFxType, RoleVideoConfig>> = {
  ...
  lose_card: {
    mp4: "/video/LOST_CARD.mp4",
    roleEn: "INFLUENCE",
    roleTh: "เสียอิทธิพล",
    actionEn: "INFLUENCE LOST",
    actionTh: "สูญเสียการ์ด 1 ใบ",
    accentHex: "#f43f5e",
  ...
  player_eliminated: {
    mp4: "/video/PLAYER_ELIMINATED.mp4",
    roleEn: "THE COURT",
    roleTh: "ผู้เล่นถูกกำจัด",
    actionEn: "PLAYER ELIMINATED",
    actionTh: "ถูกกำจัดออกจากเกม",
    accentHex: "#dc2626",
